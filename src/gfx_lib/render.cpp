...
struct FormatInfoMap
{
    FormatInfoMap()
    {
        ...
        set(Format::R16G16B16_TYPELESS, SLANG_SCALAR_TYPE_UINT16, 3);
        ...
        set(Format::R16G16B16_FLOAT, SLANG_SCALAR_TYPE_FLOAT16, 3);
        ...
        set(Format::R16G16B16_UINT, SLANG_SCALAR_TYPE_UINT16, 3);
