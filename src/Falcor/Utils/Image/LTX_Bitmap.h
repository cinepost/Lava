...
*/
class FALCOR_API LTX_Bitmap : public Object {
    FALCOR_OBJECT(LTX_Bitmap)
  public:
    struct TLCParms {
    ...
    */
    static SharedConstPtr createFromFile(Falcor::SharedPtr<Device> pDevice, const fs::path& path, bool isTopDown = true);
    static SharedConstPtr createFromFile(Falcor::SharedPtr<Device> pDevice, const std::string& filename, bool isTopDown = true);
