...
#ifndef HDLAVA_CAMERA_H_
#define HDLAVA_CAMERA_H_
...
class HdLavaCamera : public HdCamera {

public:
    HdLavaCamera(SdfPath const& id);
    ~HdLavaCamera() override = default;
