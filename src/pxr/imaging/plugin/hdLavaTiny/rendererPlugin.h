...
///
/// \class HdLavaTinyRendererPlugin
///
...
///
class HdLavaTinyRendererPlugin final : public HdRendererPlugin 
{
public:
    HdLavaTinyRendererPlugin() = default;
    virtual ~HdLavaTinyRendererPlugin() = default;

    /// Construct a new render delegate of type HdLavaTinyRenderDelegate.
...
private:
    ...
    HdLavaTinyRendererPlugin(const HdLavaTinyRendererPlugin&) = delete;
    HdLavaTinyRendererPlugin &operator =(const HdLavaTinyRendererPlugin&) = delete;
};
