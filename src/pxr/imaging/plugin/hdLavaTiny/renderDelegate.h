...
///
/// \class HdLavaTinyRenderDelegate
///
...
///
class HdLavaTinyRenderDelegate final : public HdRenderDelegate 
{
public:
    /// Render delegate constructor. 
    HdLavaTinyRenderDelegate();
    /// Render delegate constructor. 
    HdLavaTinyRenderDelegate(HdRenderSettingsMap const& settingsMap);
    /// Render delegate destructor.
    virtual ~HdLavaTinyRenderDelegate();
...
private:
    ...
    HdLavaTinyRenderDelegate(const HdLavaTinyRenderDelegate &) = delete;
    HdLavaTinyRenderDelegate &operator =(const HdLavaTinyRenderDelegate &) = delete;
};
