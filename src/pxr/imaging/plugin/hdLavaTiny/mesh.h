...
///
class HdLavaTinyMesh final : public HdMesh 
{
public:
    HF_MALLOC_TAG_NEW("new HdLavaTinyMesh");

    /// HdLavaTinyMesh constructor.
    ...
    HdLavaTinyMesh(SdfPath const& id, SdfPath const& instancerId = SdfPath());

    /// HdLavaTinyMesh destructor.
    ~HdLavaTinyMesh() override = default;
...
protected:
    ...
    HdLavaTinyMesh(const HdLavaTinyMesh&) = delete;
    HdLavaTinyMesh &operator =(const HdLavaTinyMesh&) = delete;
};
