...
set(TIFF_NAMES ${TIFF_NAMES} tiff libtiff tiff4 libtiff4)
foreach(name ${TIFF_NAMES})
  list(APPEND TIFF_NAMES_DEBUG "${name}")
...
set(_TIFF_LIBRARYDIR_SEARCH_DIRS "")
list(APPEND _TIFF_LIBRARYDIR_SEARCH_DIRS
  ${TIFF_LIBRARYDIR}
  ${_TIFF_ROOT}
...
if(NOT TIFF_LIBRARY)
  find_library(TIFF_LIBRARY_RELEASE NAMES ${TIFF_NAMES}
      PATHS ${_TIFF_LIBRARYDIR_SEARCH_DIRS}
      PATH_SUFFIXES ${CMAKE_INSTALL_LIBDIR} ../release/lib lib
      NO_DEFAULT_PATH
    )
  find_library(TIFF_LIBRARY_DEBUG NAMES ${TIFF_NAMES_DEBUG}
      PATHS ${_TIFF_LIBRARYDIR_SEARCH_DIRS}
      PATH_SUFFIXES ${CMAKE_INSTALL_LIBDIR} ../debug/lib lib
      NO_DEFAULT_PATH
    )
