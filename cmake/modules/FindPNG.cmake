...
if(PNG_ROOT)
  set(_PNG_ROOT ${PNG_ROOT})
elseif(DEFINED ENV{PNG_ROOT})
  set(_PNG_ROOT $ENV{PNG_ROOT})
elseif(PNG_ROOT)
  set(_PNG_ROOT ${PNG_ROOT})
elseif(DEFINED ENV{PNG_ROOT})
  set(_PNG_ROOT $ENV{PNG_ROOT})
...
set(_FIND_PNG_ADDITIONAL_OPTIONS "")
if(DISABLE_CMAKE_SEARCH_PATHS)
  set(_FIND_PNG_ADDITIONAL_OPTIONS NO_DEFAULT_PATH)
endif()

if(ZLIB_FOUND)
  find_path(PNG_PNG_INCLUDE_DIR png.h
    ${_FIND_PNG_ADDITIONAL_OPTIONS}
    PATHS ${_PNG_ROOT}
  ...
  if(NOT PNG_LIBRARY)
    ...
    set(_PNG_LIBRARYDIR_SEARCH_DIRS "")
      list(APPEND _PNG_LIBRARYDIR_SEARCH_DIRS
      ${PNG_LIBRARYDIR}
      ${_PNG_ROOT}/lib
    ...
    find_library(PNG_LIBRARY_RELEASE NAMES ${PNG_NAMES} NAMES_PER_DIR
      PATHS ${_PNG_LIBRARYDIR_SEARCH_DIRS})
