if(STATIC_LIB)
	...
	if(WIN32)
		if(${BUILD_TYPE} STREQUAL Debug)
			execute_process( COMMAND ${CMAKE_COMMAND} -E copy_if_different ${SRC_DIR}/x64/Debug/FreeImaged.lib ${DEST_DIR}/lib/FreeImaged.lib )
			execute_process( COMMAND ${CMAKE_COMMAND} -E copy_if_different ${SRC_DIR}/x64/Debug/FreeImaged.dll ${DEST_DIR}/bin/FreeImaged.dll )
		else()
